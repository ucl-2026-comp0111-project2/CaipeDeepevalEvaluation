...
export QUESTIONS_PATH="/Users/alexanghh/development/caipe_ragas/rag_eval/data/enterprise_rag_bench_questions.jsonl"
...
uv run python3 src/deepeval_eval/enterprise_deepeval.py \
