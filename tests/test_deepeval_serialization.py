...
from deepeval_eval.precomputed_deepeval import write_results as write_results_precomputed
...
def test_enterprise_write_results_serialization_positive(tmp_path: Path, sample_results):
    config_args = {
...
def test_enterprise_write_results_serialization_negative(tmp_path: Path, sample_results):
...
def test_precomputed_write_results_serialization_positive(tmp_path: Path, sample_results):
    config_args = {
        "benchmark": "hotpotqa",
        "answer_mode": "short"
    }
...
def test_precomputed_write_results_serialization_negative(tmp_path: Path, sample_results):
    config_args = {
        "custom_obj": DummyObject(),
        "_private_val": "secret"
    }
